...
+ 1665: Robert Hooks use self-made microscope to observe dead cork cells
+ 1670: Leeuwenhoek made microscope with better resolution to observe living
thing
+ 1838-1839: Schieiden and Schwann general the role of cell in living thing
+ 1855: Rudolf Virchow: cells are from pre-existing cells
+ 1860s: Louis Pasteur proved that cell only originated from an pre-existing
living cell
...
micrometer. For prokoyote, genes are temporally regulated ; for eukoryote, gene are also
regulated in both spatial and temporal.

The word come from latin words:

> "eu" --> "true","good"; "karyote --> "kernel"; "pro" --> "before"

Here are the difference between prokaryote and eukaryots.
